...
import jumpWav from "../assets/sound-effects/jump.wav";
import gameOverWav from "../assets/sound-effects/gameover.wav";
import scoreWav from "../assets/sound-effects/score.wav";
...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.audio("score", scoreWav);
    this.load.audio("gameover", gameOverWav);
  }
  ...
  private setupAnimations(): void {
    this.anims.create({
      key: "player-idle",
      frames: this.anims.generateFrameNumbers("player-animation", {
        start: 0,
        end: 3,
      }),
      frameRate: 10,
